...
chcp 65001 >nul
title ESP32 Backend System (Smart)
echo ========================================
...
echo 5. MQTT Broker Status (Optional)...
echo [INFO] MQTT broker check skipped - system will work without MQTT
echo [INFO] MQTT connection warnings are normal and expected
echo.

echo All checks completed, starting system...
echo.
echo [INFO] System is starting up...
echo [INFO] MQTT connection warnings are normal (MQTT broker not required)
